...
namespace Inventarverwaltung1.Data
{
   ...
   /// </summary>
   public partial class InventarverwaltungContainerDesignTimeFactory: IDesignTimeDbContextFactory<InventarverwaltungContainer>
   {
      /// <summary>
      /// Partial method to allow post-creation configuration of the DbContext after it's created
      /// but before it's returned.
      /// </summary>
      partial void Initialize(InventarverwaltungContainer dbContext);

      /// <summary>Creates a new instance of a derived context.</summary>
      /// <param name="args"> Arguments provided by the design-time service. </param>
      /// <returns> An instance of <see cref="Inventarverwaltung1.Data.InventarverwaltungContainer" />.</returns>
      public InventarverwaltungContainer CreateDbContext(string[] args)
      {
         DbContextOptionsBuilder<InventarverwaltungContainer> optionsBuilder = new DbContextOptionsBuilder<InventarverwaltungContainer>();

         // Please provide the InventarverwaltungContainer.ConfigureOptions(optionsBuilder) in the partial class as
         ...
         InventarverwaltungContainer.ConfigureOptions(optionsBuilder);
         InventarverwaltungContainer result = new InventarverwaltungContainer(optionsBuilder.Options);
         Initialize(result);
   ...
   /// </remarks>
   public partial class InventarverwaltungContainerFactory: IDbContextFactory<InventarverwaltungContainer>
   {
      /// <summary>
      /// Partial method to allow post-creation configuration of the DbContext after it's created
      /// but before it's returned.
      ...
      public InventarverwaltungContainer CreateDbContext()
      {
         DbContextOptionsBuilder<InventarverwaltungContainer> optionsBuilder = new DbContextOptionsBuilder<InventarverwaltungContainer>();
